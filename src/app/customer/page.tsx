...
// --- move InputDemo inside the file ---
const InputDemo = ({ value, onChange }: { value: string; onChange: (e: React.ChangeEvent<HTMLInputElement>) => void }) => {
...
const Customer = () => {
  ...
  const handleCardClick = async (e: React.FormEvent) => {
    alert("Login required to perform action!!");
    router.push('/login');
  };
